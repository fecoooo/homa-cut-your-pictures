...
public class GamePrefs : MonoBehaviourSingleton<GamePrefs>
{
	...
	{
		new LevelData(4, new Vector2(0.1598f, -0.7364f),	-90,	"Levels/template_11", "Levels/piece_11", "Levels/outline_11", 1270),
		new LevelData(3, new Vector2(1.6782f, -0.5857f),	0,		"Levels/template_12", "Levels/piece_12", "Levels/outline_12", 790),
